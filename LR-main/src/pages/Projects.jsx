...
const ALL_PROJECTS = [
  ...
  { id: 44, title: "Home MS Containers", category: "home-containers", tag: "Home Containers", img: container6, desc: "Modern Home MS Containers designed for comfortable and stylish living spaces. Built with durable steel, quick installation, and customizable interiors for long-lasting residential use." },
  { id: 45, title: "PUF MS Container", category: "puf-containers", tag: "PUF Container", img: container7, desc: "Insulated PUF containers designed for superior thermal performance and durability. Ideal for site offices, storage, accommodation, and industrial applications with quick installation and energy efficiency." },
  { id: 46, title: "Hinge MS Container", category: "hinge-containers", tag: "Hinge Container", img: container8, desc: "Hinge MS containers designed for easy access, secure storage, and industrial applications. Built with durable mild steel, quick installation, and reliable long-term performance." },
